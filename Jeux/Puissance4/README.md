...
|-----------|--------|-------------|
| `PROFONDEUR` | `4` | Nombre de coups anticipés |
| `alpha` / `beta` | `-∞` / `+∞` | Élagage alpha-bêta pour optimiser les performances |

**Logique de `score_fenetre()`** :

| Situation | Score |
|-----------|-------|
| 4 jetons bot | +100 |
| 3 jetons bot + 1 vide | +5 |
| 2 jetons bot + 2 vides | +2 |
| 3 jetons joueur + 1 vide | -80 (blocage urgent) |
...
| `chips` | `[red, yellow]` | Images des jetons rouge (joueur 1) et jaune (joueur 2 / bot) |
| `screen` | `Surface 900×800` | Fenêtre principale pygame |
