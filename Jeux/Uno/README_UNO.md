...
> **Joueur 1** (bas de l'écran) · **Joueurs 2, 3, 4** = bots (gauche, haut, droite)
...
|------------|---------|------------------------------------------------------|
| `card`     | `tuple` | Tuple `(valeur, couleur)` ex: `("Turn", "Green")`    |
| `value`    | `str`   | Valeur string de la carte ex: `"Turn"`               |
| `color`    | `str`   | Couleur de la carte ex: `"Green"`                    |

| Méthode     | Retour       | Description                                                           |
|-------------|--------------|-----------------------------------------------------------------------|
| `shuffle()` | `None`       | Mélange le paquet de carte                                            |
| `draw()`    | `list[card]` | Retourne un nombre de carte du paquet                                 |
| `sort()`    | `list[card]` | Retourne une liste de main rangé Red < Blue < Green < Yellow < Jokers |
...
while main_menu()
    ...
    └── playing()                         ← boucle de jeu
        └── while True
            ├── joker_reset()
            ├── if turn % 60              ← Mélange du paquet (sauf top)
