Bienvenue dans ma collection de jeux (Cartes, Mini Jeu et Casino)! Ce `README.md` explique les rêgles des différents jeux, leur fonctionnement et comment lancer les jeux.
